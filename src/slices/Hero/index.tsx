...
// some local textures and colors incase the textures and colors are in set:
...
const Hero: FC<HeroProps> = ({ slice }) => {
  ...
  return (
    ...
    >
      ...
      <div className="grid absolute inset-0 mx-auto mt-28 max-w-6xl grid-rows-[1fr,auto] place-items-end px-6 ~py10/16">
        ...
        <div className="flex relative w-full flex-col items-center justify-between ~gap-2/4 lg:flex-row">
          ...
          <ButtonLink
            ...
            icon="skateboard"
            size="lg"
            className="z-20 mt-2 block mb-5"
          >
